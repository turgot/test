...
/**
 * <p>«COMMENTS» tag (class name is used as tag name so should be like in response)</p>
 * <p>From api doc: «A brief description of the lender, usually a slogan up to 120 characters»</p>
 * <p>Can be empty.</p>
 ...
 */
public class COMMENTS extends ApiTag {
    /**
